            ...
            List<SearchTreeEntry> entries = new List<SearchTreeEntry>()
            {
                ...
                new SearchTreeGroupEntry(new GUIContent("Actions"), 1),
                    ...
                    new SearchTreeGroupEntry(new GUIContent("General"), 2),
                        ...
                        new SearchTreeEntry(new GUIContent("Look At Target Once", _icon)) { level = 3, userData = "GraphAction_LookAtTargetOnce" },
                    new SearchTreeGroupEntry(new GUIContent("Movement"), 2),
                        ...
                        new SearchTreeGroupEntry(new GUIContent("3D"), 3),
                            ...
                            new SearchTreeEntry(new GUIContent("Move Navmesh Agent to Target 3D", _icon)) { level = 4, userData = "GraphAction_NavMeshAgentGoToTarget" },
