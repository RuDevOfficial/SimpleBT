...
[System.Serializable]
public class GraphAction_Potato : GraphAction
{
    public GraphAction_Potato()
    {
        Title = "GraphAction_Potato"; // Rename like: GraphAction_DoSomething -> Do Something
        ClassReference = "Action_Potato"; // Rename like: GraphAction_DoSomething -> Action_DoSomething
    }
