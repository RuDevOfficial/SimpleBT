...
[System.Serializable]
public class GraphAction_NewTest : GraphAction
{
    public GraphAction_NewTest()
    {
        Title = "New Test"; // Rename like: GraphAction_DoSomething -> Do Something
        ClassReference = "Action_NewTest"; // Rename like: GraphAction_DoSomething -> Action_DoSomething
    }
